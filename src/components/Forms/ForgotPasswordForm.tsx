...
import { PasswordResetSchema, passwordResetSchema } from "@/lib/formValidation";
  ...
  const onSubmit = async (values: PasswordResetSchema) => {
    try {
      ...
      toast.promise(promise, {
        ...
        success: () => ({
          message: `Email Sent`,
          description: `Please verify the email Sent to set new Password`,
        }),
        error: (error) => ({
          message: "Error",
          description:
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Enter your Email in the space provided below.
          </CardDescription>
        </CardHeader>
