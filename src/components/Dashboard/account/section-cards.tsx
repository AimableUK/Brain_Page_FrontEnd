  ...
  return (
    <div className="w-full flex flex-col gap-3">
      <div className="flex flex-col md:flex-row w-full gap-3">
        <Card className="@container/card card bg-gradient-to-t from-primary/5 to-card dark:bg-card w-full">
      ...
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <Card className="@container/ card bg-gradient-to-t from-primary/5 to-card dark:bg-card w-full">
          <CardHeader className="relative">
